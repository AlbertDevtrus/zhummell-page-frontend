        ...
        <main className="scroll-smooth">
            <section className="h-screen w-full flex flex-row justify-center items-left p-20">
                ...
                <div className="flex flex-col justify-center items-start text-balance">
                    ...
                    <Link to="/catalog" className='absolute bg-white text-black font-lexend py-2 px-4 rounded-sm text-xl bottom-14 hover:bg-gray-300 transition-all duration-200 animate-fade-right'>Buy here!</Link>
                </div>
            ...
            <section 
                ...
                style={{
                    backgroundImage: "url('../static/saturn.jpg')",
                }}
                ref={numbersRef}
            >
                <div>
